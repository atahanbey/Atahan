					...
					<div class="inbox-body">
						<div class="mail-options">
							...
							<div class="refresh-container">
								<a href="onemliMesajlar.php"><i class=" fa fa-refresh"></i></a>
							</div>
						</div>
						<div class="mail-box">
                            ...
                            <tr>
									...
									<td>
										<a href="#"><i class="fa fa-star mail-star" style="color:orange"></i></a>
									</td>
									<td>
										<a href="#" class="mail-text">FAR-TECH</a>
									</td>
									<td>
										<a href="#" class="mail-text">Şifrenizi başarıyla güncellediniz.</a>
									</td>
									<td class="mail-paperclip">
										<a href="#"><i class="fa fa-paperclip"></i><a>
									</td>
									<td class="mail-clock"><a href="#">11 Kasım 2023<a></td>
								</tr>
