						...
						<div class="mail-box">
							<table class="mail-table">
								...
								<tr>
									...
									<td>
										<a href="#" class="mail-text">Emre DEMİR</a>
									</td>
									<td>
										<a href="#" class="mail-text">If you can touch it, you can catch it big boss böyle devam et.</a>
									</td>
									<td class="mail-paperclip">
										<a href="#"><i class="fa fa-paperclip"></i><a>
									</td>
									<td class="mail-clock"><a href="#">14 Aralık 2023<a></td>
								</tr>
								<tr>
									<td>
										<a href="#"><input type="checkbox" class="mail-checkbox"></a>
									...
									<td class="mail-clock"><a href="#">12 Aralık 2023<a></td>
								</tr>
